...
class DatasetLVIS(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        lvis_ins_meta = MetadataCatalog.get('lvis_v1_train')
        self.class_names = lvis_ins_meta.thing_classes
    ...
    def __getitem__(self, idx):
        ...
        batch = {'query_img': query_img,
                 ...
                 'class_name': self.class_names[class_sample-1]
                 }
...
if __name__ == '__main__':
    ...
    for idx in range(len(dataset)):
        ...
        save_path = f'shows/lvis/fold{fold}/{class_name}_{query_n}'
