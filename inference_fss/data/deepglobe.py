...
if __name__ == '__main__':
    ...
    for fold in tqdm([0,]):
        ...
        dataset = DatasetDeepglobe(datapath, fold=fold, transform=transform, split=split, shot=1,
                                          use_original_imgsize=False)
        ...
        for idx in range(len(dataset)):
            ...
            if not os.path.exists(f'shows/Deepglobe/fold{fold}'):
                os.makedirs(f'shows/Deepglobe/fold{fold}')

            save_path = f'shows/Deepglobe/fold{fold}/{query_n}'
