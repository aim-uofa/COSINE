...
class DatasetCOCO(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        coco_ins_meta = MetadataCatalog.get('coco_2017_train_ins')
...
if __name__ == '__main__':
    ...
    dataset = DatasetCOCO(datapath, fold=fold, transform=transform, split=split, shot=1,
                                      use_original_imgsize=False)
    ...
    for idx in range(len(dataset)):
        ...
        if not os.path.exists(f'shows/coco/fold{fold}'):
            os.makedirs(f'shows/coco/fold{fold}')

        save_path = f'shows/coco/fold{fold}/{class_name}_{query_n}'
