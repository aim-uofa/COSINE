...
def get_ref_masks(args):
    obj_dict = {
        "lung": {'id': 1, 'category_id': 1, 'file_name': 'CHNCXR_0003_0.png', 'gt_name': 'CHNCXR_0003_0_mask.png'},
        "nevus": {'id': 1, 'category_id': 1, 'file_name': 'ISIC_0000001.jpg', 'gt_name': 'ISIC_0000001_segmentation.png'},
        "truck": {'id': 1, 'category_id': 1, 'file_name': 'P0003_206_462_206_462.png', 'gt_name': 'P0003_206_462_206_462_instance_color_RGB.png'},
        "airplane": {'id': 1, 'category_id': 1, 'file_name': 'P0168_618_874_1648_1904.png', 'gt_name': 'P0168_618_874_1648_1904_instance_color_RGB.png'},
        "boat": {'id': 1, 'category_id': 1, 'file_name': 'P0053_0_256_1030_1286.png', 'gt_name': 'P0053_0_256_1030_1286_instance_color_RGB.png'},
        "car": {'id': 1, 'category_id': 1, 'file_name': 'P0086_1030_1286_618_874.png', 'gt_name': 'P0086_1030_1286_618_874_instance_color_RGB.png'},
        "defects": {'id': 1, 'category_id': 1, 'file_name': '0.jpg', 'gt_name': '0.png'},
        "defects2": {'id': 1, 'category_id': 1, 'file_name': '1.jpg', 'gt_name': '1.png'},
    }
...
def read_data(ref_data_cls, data_info, image_size, args):
    ...
    for ind, ann in enumerate(ref_data_cls["annotations"]):
        ...
        label_file = os.path.join(gt_dir, ann["gt_name"])
...
def test(model, ref_data, txt_data, data_info, args=None):
    ...
    for dataset_dict in dataset_dicts:
        ...
        # out = v.draw_sem_seg(pred_masks.to("cpu"), None)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vis_notext', action="store_true")
