...
class DatasetMapper:
    ...
    def from_config(cls, cfg, is_train: bool = False):
        ...
        ret = {
            ...
            "clip_image_size": cfg.INPUT.CLIP_IMAGE_SIZE,
            "augmentations": augs,
            ...
            "is_preprocess": cfg.MODEL.COSINE.preprocess
        }
    ...
    def __call__(self, dataset_dict):
        ...
        dataset_dict["instances"].ins_ids = torch.tensor(list(range(len(gt_classes))), dtype=torch.int64)
        class_names = {cat_id: self.class_names[cat_id] for cat_id in gt_classes.tolist()}
