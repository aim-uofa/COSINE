...
_PREDEFINED_SPLITS_LVIS = {
    "lvis_v0.5": {
        ...
        # "lvis_v0.5_val": ("coco2017/val2017", "lvis/lvis_v0.5_val.json"),
...
def register_all_lvis(root="datasets"):
    ...
    METASPLITS = [
        ...
        ("lvis_v0.5_val_novel", "coco2017/val2017", "lvis/lvis_v0.5_val.json"),
    ]
    ...
    LVIS_V1_METASPLITS = {
        "lvis_v1": {
            "lvis_v1_train_shots": ("coco/", "lvissplit/lvis_v1_shots.json"),
        }
    }
    from detectron2.data.datasets.lvis import register_lvis_instances as register_lvis_instances_v1
    from detectron2.data.datasets.lvis import get_lvis_instances_meta as get_lvis_instances_meta_v1
    for dataset_name, splits_per_dataset in LVIS_V1_METASPLITS.items():
        for key, (image_root, json_file) in splits_per_dataset.items():
            register_lvis_instances_v1(
                key,
                get_lvis_instances_meta_v1(dataset_name),
