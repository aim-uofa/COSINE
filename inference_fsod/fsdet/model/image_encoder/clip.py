...
class CLIPEncoderConvNet(nn.Module):
    ...
    def __init__(
        ...
        dim = encoder._out_feature_channels["res5"]
    ...
    def get_enc_embs(self, pixel_values: torch.FloatTensor):
        ...
        # image_embeddings = self.encoder.forward(pixel_values)["res5"] # b, c, h, w
        image_embeddings = [self.encoder.forward(pixel_values)[layer] for layer in ["res5", "clip_vis_dense"]]
