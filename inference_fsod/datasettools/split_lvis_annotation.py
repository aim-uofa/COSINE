...
def parse_args():
    ...
    parser.add_argument(
        "--data", type=str, default="datasets/lvis/lvis_v0.5_train.json", help="path to the annotation file"
    )
    parser.add_argument("--save-dir", type=str, default="datasets/lvis", help="path to the save directory")
