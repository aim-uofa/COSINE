...
from cosine.model.image_encoder.encodersoup_single_scale_ablation import build_encodersoup


from cosine.model.transformer_decoder.mformer_abla import build_mformer, MLP
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_feats_merging_type', type=str, default="only_dino")
    ...
    parser.add_argument("--prompt_update", action="store_true", default=False)
    parser.add_argument("--prompt_selfattn", action="store_true", default=True)
