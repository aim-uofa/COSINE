...
from . import build_clip_ms, build_dinov2_ms
...
class EncoderSoup(nn.Module):
    ...
    def encode_prompt(self, batched_visual_prompt, batched_text_prompt, batched_tag):
        ...
        if self.combine_vis_text:
            return self.encode_prompt_combine_vis_text(batched_visual_prompt, batched_text_prompt, batched_tag)
