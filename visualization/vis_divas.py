...
if __name__ == '__main__':
    ...
    prediction_path = os.path.join(root, "D17")
    video_path = "datasets/vos/DAVIS/2017"

    output_path = os.path.join(root, 'vis_new')

    # prediction_path = os.path.join(prediction_path, 'Annotations')
    video_path = os.path.join(video_path, 'trainval/JPEGImages/480p')
