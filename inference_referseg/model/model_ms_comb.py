...
from inference_referseg.model.image_encoder.encodersoup_ms import build_encodersoup
from cosine.model.pixel_decoder.msdeformattn import build_pixel_decoder
from inference_referseg.model.transformer_decoder.mformer_ms import build_mformer, MLP
...
class COSINE(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        prompts = batched_inputs[0]["txt_prompts_all"]
